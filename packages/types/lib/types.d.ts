...
export type PooledUserOpHashesRequest = ValueOf<typeof ssz.PooledUserOpHashesRequest>;
export type PooledUserOpHashes = ValueOf<typeof ssz.PooledUserOpHashes>;
export type PooledUserOpsByHashRequest = ValueOf<typeof ssz.PooledUserOpsByHashRequest>;
...
export type addSuffix<TKey, TSuffix extends string> = TKey extends string ? `${TKey}${TSuffix}` : never;
