...
export const SupportedMempools = new ListCompositeType(MempoolId, MAX_SUPPORTED_MEMPOOLS);
...
export const PooledUserOpsByHash = new ListCompositeType(UserOp, MAX_OPS_PER_REQUEST);
