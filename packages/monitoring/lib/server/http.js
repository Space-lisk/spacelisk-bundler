...
export async function getHttpMetricsServer(port, address, registry, logger) {
    ...
    const scrapeTimeMetric = new Histogram({
    ...
    await new Promise((resolve, reject) => {
        ...
        server.listen(port, address, () => {
            ...
            logger.info({ address, stats: `${address}/metrics` }, "Started metrics HTTP server");
            resolve();
        });
    });
    return {
